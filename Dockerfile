# Model Risk Validation Copilot (model-risk-validation) serving image.
#
...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    MRM_PROFILE=gcp \
    MRM_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn model_risk_validation.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
